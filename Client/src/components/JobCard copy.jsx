const JobCard = (props) => {
  return (
    <div className="p-8 flex items-center space-x-6 bg-white shadow-md shadow-gray-300 rounded">
      <div className="rounded-full">
        <img
          src="https://play-lh.googleusercontent.com/K_-SxUrxyAYAs_clNCjP8-xHWkNdEJtX6iNGLsYPz4hbeREfyr_XVn6PRPfOZcfKY6M"
          alt="logo"
          className="sm:w-44 sm:h-44 w-32 h-32 object-cover mx-auto rounded-full"
        />
      </div>
