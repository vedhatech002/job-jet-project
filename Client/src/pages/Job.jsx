  ...
  return (
    <div className="mt-10">
      ...
      <div className="text-black space-y-2">
        ...
        <div className="m-4">
            <p className="text-lg">
              The job experience needed is 0 to 1.
              Skills required : ReactJS, TailwindCSS, Github, JavaScript
            </p>
        </div>
        <div className="space-x-4">
          <a href="#" className="underline underline-offset-4 underline-blue-500 text-blue-500 hover:cursor-pointer hover:text-gray-600">Update</a>
          <button className="bg-blue-500 text-white p-2 rounded hover:bg-white hover:text-blue-500 hover:border-2 border-blue-500">Delete</button>
        </div>
        </div>
    </div>
  );
